...
namespace WebApi
{
    [EventSource(Name = "MyCompany-POC_Logging_CorrelationID-WebApi")]
    internal sealed class WebApiEventSource : EventSource
    {
        public static readonly WebApiEventSource Current = new WebApiEventSource();

        static WebApiEventSource()
        {
        ...
        private WebApiEventSource() : base() { }
        ...
        public void ServiceRequestStart(string requestTypeName, string correlationId, string order)
        {
            WriteEvent(ServiceRequestStartEventId, requestTypeName, correlationId, order);
        }
