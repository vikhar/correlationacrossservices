...
{
    [EventSource(Name = "MyCompany-POC_Logging_CorrelationID-StatelessService1")]
    internal sealed class ServiceEventSource : EventSource
    {
        ...
        [Event(ServiceRequestStartEventId, Level = EventLevel.Informational, Message = "Service request '{0}' started HELLO", Keywords = Keywords.Requests)]
        public void ServiceRequestStart(string requestTypeName, string correlationId)
        {
            SetCurrentThreadActivityId(new Guid(correlationId));
            WriteEvent(ServiceRequestStartEventId, requestTypeName, correlationId);
        }

        [Event(9, Level = EventLevel.Informational, Message = "Service request '{1}' started", Keywords = Keywords.Requests)]
        public void ServiceRequestStart1(string correlationId, string requestTypeName)
        {
            WriteEvent(9, correlationId, requestTypeName);
        }

        private const int ServiceRequestStopEventId = 6;
        [Event(ServiceRequestStopEventId, Level = EventLevel.Informational, Message = "Service request '{0}' finished", Keywords = Keywords.Requests)]
        public void ServiceRequestStop(string requestTypeName, string correlationId, string exception = "")
        {
            
            WriteEvent(ServiceRequestStopEventId, requestTypeName, correlationId, exception);
        }
        #endregion
